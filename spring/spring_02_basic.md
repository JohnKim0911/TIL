...
| 11 | [다음으로](#11-다음으로)                                              | 25분       | 4           | 2024.12.22 (일)             |
|    |                                                               | 총 12시간 5분 | 총 230 페이지   | 2024.12.16 (월) ~ 12.22 (일) |

> 2024.12.23 (월) - 전체 복습 및 요약: [(복습) 스프링 핵심 원리 - 기본편 (요약)](spring_02_basic_summary.md)
...
- 다음 강의
  - 김영한의 스프링 완전 정복 로드맵: https://www.inflearn.com/roadmaps/373
    - `3번째)` 모든 개발자를 위한 HTTP 웹 기본 지식: https://inf.run/8ZEU8